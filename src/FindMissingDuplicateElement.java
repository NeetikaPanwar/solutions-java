...
public class FindMissingDuplicateElement {
    ...
    public ArrayList<Integer> repeatedNumber(final List<Integer> A) {
        ...
        for(Integer element: A){
            ...
            System.out.println("----middle of product--" + currentProduct);
            if(currentProduct < 0)
            	currentProduct = Integer.MAX_VALUE;
            if(currentSum < 0)
            	currentSum = Integer.MAX_VALUE;
            
        }
        for(int i = 1; i <= A.size(); i++){
            idealProduct = idealProduct * i;
            idealSum = idealSum + i;
            if(idealProduct < 0)
            	idealProduct = Integer.MAX_VALUE;
            if(idealSum < 0)
            	idealSum = Integer.MAX_VALUE;
        }
        System.out.println("currentProduct " + currentProduct);
        System.out.println("idealProduct " + idealProduct);
        int gcdElement = gcd(idealProduct, currentProduct);
        int a = 0;
        int b = 0;
        int n = 0;
        int m = 0;
//        
//        if(gcdElement > 0){
//        n = idealProduct/gcdElement;
//        m = currentProduct/gcdElement;
//        }
//        if(currentSum > idealSum){
//            //b, the number which is missing, is less
//            if(n < m){
//                b = n;
//                a = m;
//            }
//        }
//        else{
//            //a, the number occurring twice is less
//            if(n > m){
//                b = n;
//                a = m;
//            }
//        }   
    ...
    public int gcd(int idealProduct, int currentProduct){
    	int  a = currentProduct-idealProduct;
    	System.out.println("============a===========" + a);
//    	if(currentProduct > idealProduct)
//    		 return gcd(idealProduct, currentProduct - idealProduct);
//    	else if(idealProduct > currentProduct)
//            return gcd(idealProduct - currentProduct, currentProduct);
//        else
//            return idealProduct;
    	return a;
